...
import com.wave.libs.mvvmlibs.listener.OnBackPressedListener;
...
public class BackTools {
     ...
     * @see #onBackPressed(Fragment)
     * @see #onBackPressed(FragmentActivity)
     */
    public static boolean onBackPressed(FragmentManager fragmentManager) {
        ...
        for (int i = fragments.size() - 1; i >= 0; i--) {
            ...
            if (isFragmentBackPressed(child)) {
                return true;
            }
        }
     ...
     * @return 如果处理了back键则返回 <b>true</b>
     */
    public static boolean isFragmentBackPressed(Fragment fragment) {
